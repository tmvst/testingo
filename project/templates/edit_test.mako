<div id="newq">
    <form action="#" id="form_showT">
        ...
        <div class="form-group">
            <input type="text" id="start_time" class="form-control" name="edit_start_time" value="${test.start_time.strftime('%m/%d/%Y %H:%M')}">
            <input type="text" id="end_time" class="form-control" name="edit_end_time" value="${test.end_time.strftime('%m/%d/%Y %H:%M')}">
        </div>
    </form>
</div>