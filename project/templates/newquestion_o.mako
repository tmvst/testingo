...
<%block name="page_content">
    ...
    <div class="page-header">
        <h1>Nová otázka s otvorenou odpoveďou</h1>
    </div>
    ...
    <div id="newq">
        <form action="#" id="form_o">
            ...
            <div id="answer_o">
                ...
                <textarea type="text" id="s#{ix}" name="odpoved" class="open form-control" placeholder="Odpoveď vyplniť môžete pre vlasnú kontrolu pri opravovaní. Otázka nie je automaticky vyhodnocovaná."></textarea>
            </div>
